...
class SnapshotService:
    ...
    def restore_snapshot_to_today(self, source_date: date) -> dict:
        ...
        restored_df = self._build_snapshot_from_master(master_df, source_df, today)
    ...
    def ensure_snapshot_for_date(self, snapshot_date: date) -> pd.DataFrame:
        ...
        if previous_date:
            ...
            new_snapshot = self._build_snapshot_from_master(master_df, previous_df, snapshot_date)
        else:
            ...
            new_snapshot = self._build_snapshot_from_master(master_df, None, snapshot_date)
